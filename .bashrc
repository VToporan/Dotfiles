...
GREEN="\[\033[38;5;10m\]"
CYAN="\[\033[38;5;14m\]"
ORANGE_B="\[\033[38;5;214m\]\e[1m"
#PS1="$GREEN\u@\h: $CYAN\w $ORANGE_B\$(parse_git_branch)$RED\$($?)$RESET\n>$ "
...
_prompt_command() {
    local EXIT="$?"
    if [ $EXIT -ne 0 ]; then
        PS1="$GREEN\u@\h: $CYAN\w $ORANGE_B\$(parse_git_branch)$RED($EXIT) $RESET\n>$ "
    else
        PS1="$GREEN\u@\h: $CYAN\w $ORANGE_B\$(parse_git_branch) $RESET\n>$ "
    fi
}
